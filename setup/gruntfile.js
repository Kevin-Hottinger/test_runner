module.exports = function(grunt) {
	...
	var karma_json = grunt.file.readJSON('json/karma_files.json');
    ...
    grunt.registerTask('run', ['karma', 'connect', 'watch']);
	grunt.registerTask('setup', ['sass', 'htmlmin', 'uglify', 'connect', 'karma']);
